...
public class PrepTSWithLabel extends Configured implements Tool {
...
//          text.set(parsed);
  ...
  protected JobConf configStage1() throws Exception {
    final JobConf conf = new JobConf(getConf(), PrepTSWithLabel.class);
  ...
  public static void main(String[] args) throws Exception {
    final int result = ToolRunner.run(new Configuration(), new PrepTSWithLabel(), args);
  ...
  public int run(String[] args) throws Exception {
    ...
    System.out.println("\n[Preprossing time series with label] Data Preprocessed.");
    System.out.println(String.format("[Preprossing time series with label] total runing time: %d secs", elapse));
